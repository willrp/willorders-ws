...
class ErrorHandler(object):
    ...
    def handle_error(self):
        errors = {
            ...
            DatabaseError: self.__handle_SQLDatabaseError,
    ...
    def __handle_SQLDatabaseError(self):
        message = re.search(r"DETAIL:  (.+)\n", str(self.error.orig))
        if message is None:
            abort(400, error=str(self.error.orig))
        else:
            abort(400, error=message.group(1))
